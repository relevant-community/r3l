...
// 	suite.populateClaims(ctx, num)
// 	query := abci.RequestQuery{
// 		Path: strings.Join([]string{custom, types.QuerierRoute, types.QueryAllClaims}, "/"),
// 		Data: cdc.MustMarshalJSON(types.NewQueryAllClaimsParams(1, num)),
// 	}

// 	bz, err := suite.querier(ctx, []string{types.QueryAllClaims}, query)
// 	suite.Nil(err)
// 	suite.NotNil(bz)
...
// 	query := abci.RequestQuery{
// 		Path: strings.Join([]string{custom, types.QuerierRoute, types.QueryAllClaims}, "/"),
// 		Data: cdc.MustMarshalJSON(types.NewQueryAllClaimsParams(0, num)),
// 	}
